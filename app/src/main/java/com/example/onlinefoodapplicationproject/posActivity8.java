...
public class posActivity8 extends AppCompatActivity {

    private View hideView, pos8;
    TextView back;
    EditText EsendPos8;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pos8 = findViewById(R.id.sendpos8);
        EsendPos8 = findViewById(R.id.rsenter);
        ...
        pos8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int x=Integer.parseInt(EsendPos8.getText().toString());
                //sum these two numbers
                int z = 700*x;

                DatabaseHandler databaseHandler = new DatabaseHandler(getApplicationContext());
                databaseHandler.add_Oder("Item5", 700 + "", x + "", z + "");

                Toast.makeText(posActivity8.this, "Click Position 1", Toast.LENGTH_SHORT).show();
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(posActivity8.this, MainActivity.class);
                startActivity(intent);
            }
        });
